...
\begin{subfigure}[b]{0.45\linewidth}\centering\includegraphics[width=\linewidth]{6stateV2_Thermodynamic_efficiency_NaK_2.png}\caption{6-state model}\end{subfigure}
\begin{subfigure}[b]{0.45\linewidth}\centering\includegraphics[width=\linewidth]{15state_Thermodynamic_efficiency_NaK_2.png}\caption{15-state model}\end{subfigure}
\end{minipage}
\end{document}
