...
\begin{align*}
u_m^1 & = RT\ln(K_1q_m^1) & u_m^2 & = RT\ln(K_2q_m^2) & u_m^3 & = RT\ln(K_3q_m^3) & u_m^4 & = RT\ln(K_4q_m^4) & u_m^5 & = RT\ln(K_5q_m^5) \\
u_m^6 & = RT\ln(K_6q_m^6) & u_m^7 & = RT\ln(K_7q_m^7) & u_m^8 & = RT\ln(K_8q_m^8) & u_m^9 & = RT\ln(K_9q_m^9) & u_m^{10} & = RT\ln(K_{10}q_m^{10}) \\
u_m^{11} & = RT\ln(K_{11}q_m^{11}) & u_m^{12} & = RT\ln(K_{12}q_m^{12}) & u_m^{13} & = RT\ln(K_{13}q_m^{13}) & u_m^{14} & = RT\ln(K_{14}q_m^{14}) & u_m^{15} & = RT\ln(K_{15}q_m^{15})
\end{align*}

\begin{align*}
u_i^{K+} & = RT\ln(K_i^Kq_i^{K+}) & u_i^{Na+} & = RT\ln(K_i^{Na}q_i^{Na+}) & u_o^{Na+} & = RT\ln(K_o^{Na}q_o^{Na+}) & u_o^{K+} & = RT\ln(K_o^Kq_o^{K+})\\
u_i^{MgATP} & = RT\ln(K_i^{MgATP}q_i^{MgATP}) & u_i^{MgADP} & = RT\ln(K_i^{MgADP}q_i^{MgADP}) & u_i^{P_i} & = RT\ln(K_i^{P_i}q_i^{P_i}) & u_i^{H} & = RT\ln(K_i^{H}q_i^{H}) \\
\end{align*}
...
&\qquad
v_m^{6}  &= \kappa_6 \left( K_6 q_m^6 - K_7 q_m^7 K_i^{MgADP} q_i^{MgADP} \right) \\[6pt]
...
&\qquad
v_m^{14} &= \kappa_{14} \left( K_{14} q_m^{14} K_i^{MgATP} q_i^{MgATP}
