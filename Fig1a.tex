...
\begin{tikzpicture}
  ...
  \node[OliveGreen](v0) at ($(zero) + (90:2cm)$) {$v_j^0$};
  \node[OliveGreen](v1) at ($(zero) + (162:2cm)$) {$v_j^1$};
  \node[OliveGreen](v2) at ($(zero) + (234:2cm)$) {$v_j^2$};
  \node[OliveGreen](v3) at ($(zero) + (306:2cm)$) {$v_j^3$};
  \node[OliveGreen](v4) at ($(zero) + (18:2cm)$) {$v_j^4$};
    \draw[arrow] (v0) -- (zero);
    \draw[arrow] (v1) -- (zero);
    \draw[arrow] (v2) -- (zero);
    \draw[arrow] (v3) -- (zero);
...
\node[OliveGreen](vL1) at ($(zero) + (180:2cm)$) {$v_j^0$};
\node[OliveGreen](vL2) at ($(zero) + (150:2cm)$) {$v_j^1$};
\node[OliveGreen](vR1) at ($(zero) + (0:2cm)$) {$v_j^2$};
\node[OliveGreen](vR2) at ($(zero) + (30:2cm)$) {$v_j^3$};
\draw[arrow] (vL1) -- (zero);
\draw[arrow] (vL2) -- (zero);
\draw[arrow] (zero) -- (vR1);
\draw[arrow] (zero) -- (vR2);
...
\node[OliveGreen](vL1b) at ($(combined) + (180:2cm)$) {$v_j^0$};
\node[OliveGreen](vL2b) at ($(combined) + (150:2 cm)$) {$v_j^1$};
\node[OliveGreen](vR1b) at ($(combined) + (0:2cm)$) {$v_j^2$};
\node[OliveGreen](vR2b) at ($(combined) + (30:2cm)$) {$v_j^3$};
...
\begin{tikzpicture}[node distance=12mm and 0mm,trim left=-1mm, trim right=5mm]
\def\sep{6mm}
\def\sepp{12mm}
...
\node[rectred,above=\sepp of top-1-5] (C)  {$q_m^{C}$} ;
\foreach \i in {1,...,4}{
