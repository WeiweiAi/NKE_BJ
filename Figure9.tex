...
\begin{subfigure}[b]{0.45\linewidth}\centering\includegraphics[width=\linewidth]{6stateV2_Mean_flow_rate_deltaATP_2.png}\caption{6-state model}\end{subfigure}
\begin{subfigure}[b]{0.45\linewidth}\centering\includegraphics[width=\linewidth]{15state_Mean_flow_rate_deltaATP_2.png}\caption{15-state model}\end{subfigure}
\end{minipage}
\end{document}
