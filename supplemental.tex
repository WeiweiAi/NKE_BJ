...
% 4-state model
\begin{figure}
\caption{Bond graph mode of \Gls{nka} with 4 states.}
\label{fig:4state}
\centering
\includegraphics[width=0.7\linewidth]{4state_1.pdf}
\end{figure}

\input{4state_eqs.tex}
...
\begin{subfigure}{0.495\textwidth}
      \centering
      \includegraphics[width=\linewidth]{figures/EA_2D_combine_15state_Chemical_conversion_efficiency.png}  
      \caption{15-state model}    
\end{subfigure}
\hfill
\begin{subfigure}{0.495\textwidth}
      \centering  
      \includegraphics[width=\linewidth]{figures/EA_2D_combine_6state_Chemical_conversion_efficiency.png}
      \caption{6-state model}    
\end{subfigure}
\caption{Chemical conversion efficiency of \gls{nka} (a) (15-state model) and (b) (6-state model).}
\label{fig:Chemical_conversion_efficiency_AP} 
\end{figure} 
