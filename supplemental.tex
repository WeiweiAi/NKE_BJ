...
\begin{enumerate}
    ...
    \item \textit{python plot\_EA\_2D\_combine15state.py} and \textit{python plot\_EA\_2D\_combine6stateV2.py} to reproduce Figure 6 in the main paper.
    \item \textit{python plot\_EA\_2D\_combine15state\_deltaATP.py} and \textit{python plot\_EA\_2D\_combine6stateV2\_deltaATP.py} to reproduce Figures 7,8 and 9 in the main paper.
    \item \textit{python plot\_EA\_2D\_combine15state\_flowRate.py} and \textit{python plot\_EA\_2D\_combine6stateV2\_flowRate.py} to reproduce Figure 10 in the main paper. 
    \item \textit{python plot\_EA\_2D\_combine15state\_NaK.py} and \textit{python plot\_EA\_2D\_combine6stateV2\_NaK.py} to reproduce Figure 10 in the main paper.  
\end{enumerate}  
