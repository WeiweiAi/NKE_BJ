...
\affil[2]{ARC Centre of Excellence for the Mathematical Analysis of Cellular Systems, University of New South Wales, Sydney, New South Wales, 2052, Australia}
...
We applied the experimental conditions in \cite{pan_cardiac_2020} to fit the 6-state bond graph model to the experimental data using the differential evolution method in SciPy, shown in Figure \ref{fig:model_fit}. 
...
We can see that the thermodynamic efficiency of both models increases with lower $\Delta G_{ATP}$ values (less negative), and there is a drop in full bond graph models after the $\Delta G_{ATP}$ reaches around -48 kJ/mol. 
...
W.A., M.P., P.J.H. and D.P.N. conceptualized and designed the research. W.A. and M.P. implemented the model and analyzed the data. All authors contributed to the manuscript and approved the submitted version.
